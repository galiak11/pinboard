...
final class APIClientTests: XCTestCase {
    ...
    func testRequest_success_decodesJSON() async throws {
        let json = """
        [{"id":"1","description":"Test","alt_description":null,"width":100,"height":200,"likes":5,"created_at":"2024-01-01T00:00:00Z","user":{"id":"u1","username":"test","name":"Test User","profile_image":{"small":"https://example.com/s.jpg","medium":"https://example.com/m.jpg","large":"https://example.com/l.jpg"}},"urls":{"raw":"https://example.com/r.jpg","full":"https://example.com/f.jpg","regular":"https://example.com/re.jpg","small":"https://example.com/s.jpg","thumb":"https://example.com/t.jpg"},"exif":null,"location":null}]
        """.data(using: .utf8)!
        ...
        let photos: [UnsplashPhoto] = try await sut.request(UnsplashEndpoint.photos(page: 1))
    ...
    func testRequest_httpError_throwsAPIError() async {
        ...
        do {
            let _: [UnsplashPhoto] = try await sut.request(UnsplashEndpoint.photos(page: 1))
